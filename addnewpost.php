...
<?php if(isset($_POST["Submit"])){
    ...
    elseif(strlen($posttitle)>69)
     ...
     elseif(strlen($post)>4999)
        ...
        //Post
        global $Connectingdb;
        $sql ="INSERT INTO post(dateandtime,title,cat,author,image,post,slug)";
        $sql .="VALUES(:dateandtime,:titles,:categoryname,:adminname,:images,:posts,:slugss)";
        $stmt= $Connectingdb->prepare($sql);
        
        $stmt->bindValue(':dateandtime',$timedate);
        $stmt->bindValue(':titles',$posttitle);
        $stmt->bindValue(':categoryname',$cat);
        $stmt->bindValue(':adminname',$admin);
        $stmt->bindValue(':images',$image);
        $stmt->bindValue(':posts',$post);
        ...
        if($excute){
            ...
            $_SESSION["successmsg"]="Post added Succesfully";
...
<header class="bg-dark text-white py-3">
    ...
    <div class="row">
        <div class="col-md-12">
         <h1><i class="fa fa-list-alt" aria-hidden="true"></i> Add New Post</h1>
    ...
    <div class="offset-lg-1 col-lg-10" style="min-height:400px" >
        ...
        <div class="card bg-secondary text-light mb-3">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="posttitle" id="title" placeholder="Type title of post name" value ="">
                   <!-- Slug !-->

                 <label for="slugtitle"><span class="fieldinfo">Slug Title:</span></label>
                <input class="form-control" type="text" name="slugtitle" id="slugtitle" placeholder="Your slug title" value ="">
                </div>
            ...
            <div class="form-group mb-1"> 
               ...
               <label for="post"><span class="fieldinfo">Post:</span></label>
                <textarea class="form-control" id="post" name="fullpost" rows="8" cols="80" ></textarea>
            </div>
