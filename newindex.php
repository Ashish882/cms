...
<html class="no-js" lang="">
    ...
    <head>
        ...
        <!-- Normalize CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/css/normalize.css">
        <!-- Main CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/css/main.css">
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/css/bootstrap.min.css">
        <!-- Animate CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/css/animate.min.css">
        <!-- Font-awesome CSS-->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/https://www.radiustheme.com/demo/html/newsedge/newsedge/css/font-awesome.min.css">
        <!-- Owl Caousel CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/vendor/OwlCarousel/owl.carousel.min.css">
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/vendor/OwlCarousel/owl.theme.default.min.css">
        <!-- Main Menu CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/css/meanmenu.min.css">
        <!-- Magnific CSS -->
        <link rel="stylesheet" type="https://www.radiustheme.com/demo/html/newsedge/newsedge/text/css" href="css/magnific-popup.css">
        <!-- Switch Style CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/css/hover-min.css">
        <!-- Custom CSS -->
        <link rel="stylesheet" href="https://www.radiustheme.com/demo/html/newsedge/newsedge/style.css">
        <!-- For IE -->
        <link rel="stylesheet" type="https://www.radiustheme.com/demo/html/newsedge/newsedge/text/css" href="css/ie-only.css" />
        <!-- Modernizr Js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/modernizr-2.8.3.min.js"></script>
    </head>
    ...
    <![endif]-->
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <div class="mb-20-r ne-isotope">
                                ...
                                <div class="featuredContainer" style="position: relative; height: 1100.65px;">
                                    <div class="row politics" style="position: absolute; left: 0px; top: 0px;">
                                    ...
                                    <div class="row fashion" style="position: absolute; display: none;">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
                                    ...
                                    <div class="row travel" style="position: absolute; display: none;">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
                                    ...
                                    <div class="row gadget" style="position: absolute; display: none;">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
        ...
        <!-- Wrapper End -->
        <!-- jquery-->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/jquery-2.2.4.min.js " type="text/javascript"></script>
        <!-- Plugins js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/plugins.js " type="text/javascript"></script>
        <!-- Popper js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/popper.js " type="text/javascript"></script>
        <!-- Bootstrap js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/bootstrap.min.js " type="text/javascript"></script>
        <!-- WOW JS -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/wow.min.js"></script>
        <!-- Owl Cauosel JS -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/vendor/OwlCarousel/owl.carousel.min.js " type="text/javascript"></script>
        <!-- Meanmenu Js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/jquery.meanmenu.min.js " type="text/javascript"></script>
        <!-- Srollup js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/jquery.scrollUp.min.js " type="text/javascript"></script>
        <!-- jquery.counterup js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/jquery.counterup.min.js"></script>
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/s/waypoints.min.js"></script>
        <!-- Isotope js -->
        <script src="js/isotope.pkgd.min.js " type="text/javascript"></script>
        <!-- Magnific Popup -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/jquery.magnific-popup.min.js"></script>
        <!-- Ticker Js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/ticker.js" type="text/javascript"></script>
        <!-- Custom Js -->
        <script src="https://www.radiustheme.com/demo/html/newsedge/newsedge/js/main.js" type="text/javascript"></script>        
    </body>
